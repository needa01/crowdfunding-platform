    ...
    try:
        ...
        with transaction.atomic():
            ...
            total_razorpay_deduction = (
                ...
                + Decimal(str(razorpay_tax_paise))
            ) / Decimal("100")
...
if payment_transaction.status == TransactionStatus.SUCCESS:
    ...
    promotion_links = (
        PromotionServicePaymentTransaction.objects.filter(
            payment_transaction=payment_transaction
        ).select_related("promotion_service")
    )

    promotions = [
        link.promotion_service
...
try:
    ...
    with transaction.atomic():
        ...
        # =================================================
        # GET PROMOTIONS THROUGH LINK TABLE
        # =================================================
